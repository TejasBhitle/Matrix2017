...
public class MatrixContentProvider extends ContentProvider {
    ...
    private final Event[] events = new Event[]{
            ...
            new Event("VSM", "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.", R.drawable.virtual_stock_market, "Mega", "Quadrangle", "9am to 5pm", "Riya Bakhtiani", "8888006180", "Jainam Soni", "9619100569"),
