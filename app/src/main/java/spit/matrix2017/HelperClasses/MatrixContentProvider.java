...
public class MatrixContentProvider extends ContentProvider{
    ...
    private final Event[] events = new Event[]{
            ...
            new Event("No Escape", "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.", R.drawable.no_escape, "Fun", "Quadrangle", "9am to 5pm", "Sushmen Chaudhari", 9022536467l, "Kundan Patel", 9923416796l),
            ...
            new Event("Battle of Brains", "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.", R.drawable.battle_of_brains, "Tech", "Quadrangle", "9am to 5pm", "Shreya Ail", 9665817304l, "Utkarsha Pawar", 7507416309l),
